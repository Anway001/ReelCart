        ...
        return (
            <div className="order-detail-container">
                <div className="order-detail-header">
                    ...
                    <p className="order-detail-subtitle">Loading order information...</p>
                </div>
                <BottomNav />
            </div>
        );
        ...
        return (
            <div className="order-detail-container">
                <div className="order-detail-header">
                    ...
                    <p className="order-detail-subtitle">The order you're looking for doesn't exist.</p>
                </div>
        ...
        <div className="order-detail-container">
                ...
                {order.items.map((item, index) => (
                    <div key={index} className="order-item-detail">
                        <div className="item-info">
                            ...
                            <p>{item.food.description || item.food.discription}</p>
                        </div>
            ...
            <div className="order-summary">
                ...
                <div className="summary-row order-total">
                    ...
                    <span className="summary-value">₹{(order.totalAmount + 40).toFixed(2)}</span>
                </div>
            </div>
            <div className="order-actions">
                <Link to="/orders" className="back-btn">Back to Order History</Link>
